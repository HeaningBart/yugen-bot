...
def main():
  ...
  parser.add_argument("--split_height", "-H", type=int, default=10000, help='Sets the value of the Rough Panel Height')
  parser.add_argument("--output_files_type", "-t", type=str, default=".png", choices=['.png', '.jpg', '.jpeg', '.webp', '.bmp', '.tiff', '.tga'], help='Sets the type/format of the Output Image Files')
