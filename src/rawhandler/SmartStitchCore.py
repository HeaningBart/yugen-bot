...
def get_folder_paths(batch_mode_enabled, given_input_folder, given_output_folder):
  ...
  folder_paths = []
  path = os.getcwd()
  final_path = os.path.join(path, given_input_folder)
  given_output_folder = os.path.join(given_input_folder,"Stitched")
  if not os.path.exists(given_output_folder):
    os.mkdir(given_output_folder)
  if batch_mode_enabled == False:
    ...
    for fileName in os.listdir(given_input_folder):
      ...
      if os.path.isdir(filePath):
        folder_paths.append((filePath, os.path.join(given_input_folder,  fileName + "Stitched")))
  return folder_paths
